...
{
    public partial class CharityClear : System.Web.UI.Page
    {
		// charityclear gateway url, only change this when instructed by the integrations team
        private Uri GATEWAY_URL = new Uri("https://gateway.charityclear.com/direct/");
